...
docker tag swir-example-aws-si-configurator:v0.3.1 ${repoUri}/swir-example-aws-si-configurator:v0.3.1
...
docker tag swir-example-si-python-http-server:v0.3.1 ${repoUri}/swir-example-si-python-http-server:v0.3.1
...
docker tag swir-example-si-python-grpc-client:v0.3.1 ${repoUri}/swir-example-si-python-grpc-client:v0.3.1
docker push ${repoUri}/swir-example-si-python-grpc-client

aws ecr create-repository --repository-name swir/swir
docker tag swir:v0.3.1 ${repoUri}/swir/swir:v0.3.1
