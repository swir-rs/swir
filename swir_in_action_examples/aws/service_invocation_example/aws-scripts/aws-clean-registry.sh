...
docker rmi ${repoUri}/swir-example-si-python-http-server:v0.3.2
docker rmi ${repoUri}/swir-example-si-python-grpc-client:v0.3.2
docker rmi ${repoUri}/swir/swir:v0.3.2
docker rmi ${repoUri}/swir-example-aws-si-configurator:v0.3.2
