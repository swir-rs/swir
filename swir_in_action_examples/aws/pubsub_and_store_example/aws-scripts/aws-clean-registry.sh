...
docker rmi ${repoUri}/swir-example-java-source:v0.3.1
docker rmi ${repoUri}/swir-example-java-processor:v0.3.1
docker rmi ${repoUri}/swir-example-python-sink:v0.3.1
docker rmi ${repoUri}/swir-example-python-processor:v0.3.1
docker rmi ${repoUri}/swir/swir:v0.3.1
docker rmi ${repoUri}/swir-aws-example-configurator:v0.3.1
